...
const TechStack = () => {
  ...
  const technologies: TechItem[] = [
    ...
    { 
      name: 'Next.js', 
      icon: <FileBadge className="w-8 h-8 text-emerald-700" />, 
      description: 'React framework for production with hybrid static & server rendering',
      category: 'frontend'
    },
    { 
      name: 'JavaScript', 
      icon: <FileCode className="w-8 h-8 text-emerald-700" />, 
    ...
    { 
      name: 'Tailwind CSS', 
      icon: <Paintbrush className="w-8 h-8 text-emerald-700" />, 
    ...
    { 
      name: 'Node.js', 
      icon: <Server className="w-8 h-8 text-emerald-700" />, 
    ...
    { 
      name: 'Java', 
      icon: <Coffee className="w-8 h-8 text-emerald-700" />, 
    ...
    { 
      name: 'Git', 
      icon: <ArrowRightLeft className="w-8 h-8 text-emerald-700" />, 
      description: 'Distributed version control system',
      category: 'tools'
    },
    { 
      name: 'GitHub', 
      icon: <Github className="w-8 h-8 text-emerald-700" />, 
      description: 'Provider of Internet hosting for software development and version control',
      category: 'tools'
    },
    { 
      name: 'GitLab', 
      icon: <Gitlab className="w-8 h-8 text-emerald-700" />, 
      description: 'Web-based DevOps lifecycle tool that provides a Git repository manager',
      category: 'tools'
    },
    { 
      name: 'VS Code', 
      icon: <Monitor className="w-8 h-8 text-emerald-700" />, 
      description: 'Lightweight but powerful source code editor',
      category: 'tools'
    },
    { 
      name: 'Figma', 
      icon: <FigmaIcon className="w-8 h-8 text-emerald-700" />, 
      description: 'Cloud-based design and prototyping tool',
      category: 'tools'
    },
    { 
      name: 'Postman', 
      icon: <CornerDownRight className="w-8 h-8 text-emerald-700" />, 
  ...
  return (
    <section id="techstack" className="py-16 bg-gray-50 dark:bg-zinc-900/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {filteredTechnologies.map((tech, index) => (
            ...
            >
              <div 
                className="flex flex-col items-center p-4 bg-white dark:bg-zinc-900 rounded-lg shadow-md border border-gray-200 dark:border-zinc-800 hover:shadow-lg transition-all duration-300 hover:-translate-y-2 h-32 justify-center"
              >
                <div className="mb-3">
                  {tech.icon}
                </div>
              ...
              {hoveredTech === tech.name && (
                <div className="absolute z-10 w-48 p-3 -mt-2 text-sm bg-gray-800 rounded-md shadow-lg text-white left-1/2 transform -translate-x-1/2 -translate-y-full top-0 dark:bg-black">
                  <p>{tech.description}</p>
                  <div className="absolute w-3 h-3 bg-gray-800 dark:bg-black transform rotate-45 left-1/2 -ml-1.5 top-full -mt-1.5"></div>
                </div>
              )}
            </motion.div>
          ))}
        ...
        <motion.div
          className="mt-16 bg-white dark:bg-zinc-900 rounded-lg shadow-md border border-gray-200 dark:border-zinc-800 p-6"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
